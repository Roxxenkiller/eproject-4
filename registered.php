...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql =  "insert into `caregroup`.`register` (username, email, phone, password) 
  ...
  <div class="form-container w-100" style="max-width: 500px;">
    ...
    <form id="registerForm" method="POST" onsubmit="return validateRegister()">
      ...
      <div class="mb-3">
        ...
        <input type="tel" name="phone" class="form-control" id="regPhone" placeholder="10-digit number">
...
<script>
  function validateRegister(event) {
    ...
    // If all is valid, show success popup
    if (isValid) {
      alert("Your form has been submitted");
      document.getElementById("registerForm").submit(); // Actually submit the form
    }

    return false; // Prevent default in all cases
  }
</script>
